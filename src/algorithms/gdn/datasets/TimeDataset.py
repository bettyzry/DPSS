...
class TimeDataset(Dataset):
    def __init__(self, raw_data, edge_index, mode='train', slide_win=-1, slide_stride=-1):
        self.raw_data = raw_data

        self.config = {'slide_win': slide_win, 'slide_stride': slide_stride}
    ...
    def process(self, data, labels):
        """get arrays and predict values according to time sliding windows and stride"""
        x_arr, y_arr = [], []
        labels_arr = []
